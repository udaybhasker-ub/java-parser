import { IPatternConfig } from "./lexer";
import { CustomPatternMatcherFunc, ILexerConfig, ILexerDefinitionError, ILexingError, IMultiModeLexerDefinition, IToken, TokenType } from "@chevrotain/types";
...
export declare class Lexer {
    ...
    private traceInitPerf;
    private traceInitMaxIdent;
    private traceInitIndent;
    ...
    private handlePayloadNoCustom;
    private handlePayloadWithCustom;
    private match;
