import { AbstractProduction, Alternation, Alternative, NonTerminal, Option, Repetition, RepetitionMandatory, RepetitionMandatoryWithSeparator, RepetitionWithSeparator, Terminal } from "./gast/gast_public";
...
export declare abstract class RestWalker {
    ...
    walkFlat(flatProd: Alternative, currRest: IProduction[], prevRest: IProduction[]): void;
