...
import { IGrammarPath, IProduction, ISyntacticContentAssistPath, IToken, ITokenGrammarPath, TokenType } from "@chevrotain/types";
...
export declare function possiblePathsFrom(targetDef: IProduction[], maxLength: number, currPath?: TokenType[]): PartialPathAndSuffixes[];
