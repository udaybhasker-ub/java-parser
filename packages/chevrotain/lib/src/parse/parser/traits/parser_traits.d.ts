 ...
 */
export declare type MixedInParser = ParserConstructorImpel & ErrorHandler & LexerAdapter & LooksAhead & RecognizerApi & RecognizerEngine & Recoverable & TreeBuilder & ContentAssist & GastRecorder & PerformanceTracer;
interface MixedInCstParserConstructor {
    new (tokenVocabulary: defs.TokenVocabulary, config?: defs.IParserConfig): defs.CstParser;
}
export declare const CstParser: MixedInCstParserConstructor;
interface MixedInEmbeddedActionsParserConstructor {
    new (tokenVocabulary: defs.TokenVocabulary, config?: defs.IParserConfig): defs.EmbeddedActionsParser;
}
export declare const EmbeddedActionsParser: MixedInEmbeddedActionsParserConstructor;
export {};
